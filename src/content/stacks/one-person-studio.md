...
1. **Concept in Midjourney (Mega $120/mo).** Mood boards, style frames and
   hero stills start here. The Mega tier gives enough fast generations and
   stealth privacy that commercial work does not end up in the public feed.
...
4. **B-roll and motion tests in Kling (paid tier ~$30/mo).** Cheaper motion
   per clip than Runway; use it for the shots you expect to regenerate
   three-to-five times before they land.
...
7. **Lock the script first.** Every minute saved scripting saves ten in
   regeneration. The AI tools are fast; indecision is what makes them
   expensive.
8. **Deliver in a real NLE.** DaVinci Resolve or Final Cut for sync, color,
   captions and sound design. None of these generators replaces the edit.

## What you pay

- **Midjourney — Mega, $120/mo.** The top tier with stealth privacy and fast
  generations; the catalog price_note only lists Basic, but a working studio
  needs the privacy and quota of Mega.
...
- **Kling — paid tier, ~$30/mo.** A practical mid-tier allowance for b-roll
  generation; the catalog note says "from ~$7/mo," and studio pace lands
  higher.
...
Consistency across scenes — the same face, the same product, the same
lighting — is still manual work. Longer than a few minutes or anything with
real talent, and you are back to hybrid production with real cameras. This
stack is also brutally expensive for hobby work; it only makes sense when
the output pays the rent.
