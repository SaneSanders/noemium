...
const radarTools = [
  ...
  },
  {
    slug: 'roo-code',
    name: 'Roo Code',
    tagline: 'Open VS Code fork-of-a-fork agent (Cline lineage) with modes, MCP, and BYOK.',
    ...
    self_host: true,
    limitations: [
      'Fast-moving Cline fork — pin a release before a team install.',
      'Radar: no field run in this catalog wave.',
    ],
    receipts: ['https://github.com/RooCodeInc/Roo-Code'],
    momentum: 'blueshift',
  },
  {
  ...
  },
  {
    slug: 'flowise',
    name: 'Flowise',
    tagline: 'Open-source visual builder for LLM apps and agents, self-hostable.',
    url: 'https://flowiseai.com',
    category: 'automation',
    pricing: 'freemium',
    price_note: 'OSS self-host free; Flowise Cloud is paid',
    free_tier: true,
    open_source: true,
    api: true,
    self_host: true,
    limitations: [
      'Radar: visual agent builders sprawl; we have not run a production Flowise graph.',
      'LangChain-shaped — version drift is the tax.',
    ],
    receipts: ['https://flowiseai.com', 'https://github.com/FlowiseAI/Flowise'],
    momentum: 'blueshift',
  },
  {
    slug: 'langflow',
